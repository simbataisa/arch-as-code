...
| BSP-001 | Double-Entry Ledger | banking-solutions | Draft | radii | @payments-domain-owner | `knowledge-base/patterns/banking-solutions/double-entry-ledger.md` | T0 | BCBS 239 §6; IFRS 9; SBV Circ. 09 §IV (UNOFFICIAL) | 2026-05-16 | 2 | Wave 5A — gap-fill complete |
| BSP-002 | Idempotent Payment Key | banking-solutions | Draft | radii | @payments-domain-owner | `knowledge-base/patterns/banking-solutions/idempotent-payment-key.md` | T0 | ISO 20022 EndToEndId; SBV Circ. 09 §IV.2 (UNOFFICIAL) | 2026-05-16 | 2 | Wave 5A — full write complete |
...
| FE-001 | Web Performance Budgets | frontend | Draft | radii | @tech-lead-web | `knowledge-base/patterns/frontend/web-performance-budgets.md` | T0, T1, T2 | Core Web Vitals; W3C Web Vitals; WCAG 2.2 AA; SBV Circular 09/2020 | 2026-05-17 | 2 | Wave 5C — full write complete |
| FE-002 | Web Resilience / Offline-First | frontend | Draft | radii | @tech-lead-web | `knowledge-base/patterns/frontend/web-resilience-offline-first.md` | T1, T2 | OWASP ASVS V9; PCI-DSS §3.4; Decree 13/2023 §9 | 2026-05-17 | 2 | Wave 5C — full write complete |
| FE-003 | Web CSP Hardening | frontend | Draft | radii | @tech-lead-web | `knowledge-base/patterns/frontend/web-csp-hardening.md` | T0, T1, T2 | OWASP ASVS V14.4; PCI-DSS §6.4.3; SBV Circular 09/2020 §III.3 | 2026-05-17 | 2 | Wave 5C — full write complete |
| FE-004 | Web Feature Flags | frontend | Draft | radii | @tech-lead-web | `knowledge-base/patterns/frontend/web-feature-flags.md` | T1, T2, T3 | OWASP ASVS V14.2; SBV Circular 09/2020 §V.1 | 2026-05-17 | 2 | Wave 5C — full write complete |
| FE-005 | Web Error Boundary | frontend | Draft | radii | @tech-lead-web | `knowledge-base/patterns/frontend/web-error-boundary.md` | T0, T1, T2 | OWASP ASVS V7.4; Decree 13/2023 §6 | 2026-05-17 | 2 | Wave 5C — full write complete |
| FE-006 | Web i18n / RTL | frontend | Draft | radii | @tech-lead-web | `knowledge-base/patterns/frontend/web-i18n-rtl.md` | T0, T1, T2, T3 | WCAG 2.2 AA §3.1.1; Decree 13/2023 §4.2 | 2026-05-17 | 2 | Wave 5C — full write complete |
...
| INT-005 | Anti-Corruption Layer | integration | Draft | radii | @tech-lead-backend | `knowledge-base/patterns/integration/anti-corruption-layer.md` | T0, T1, T2 | DDD Tactical | 2026-05-16 | 2 | Wave 5A — gap-fill complete |
| INT-006 | Strangler Fig | integration | Draft | radii | @tech-lead-backend | `knowledge-base/patterns/integration/strangler-fig.md` | T1, T2 | MS Cloud Pattern | 2026-05-16 | 2 | Wave 5A — full write complete |
| INT-007 | Sidecar / Ambassador | integration | Draft | radii | @sre-lead | `knowledge-base/patterns/integration/sidecar-ambassador.md` | T0, T1 | MS Cloud Sidecar | 2026-05-16 | 2 | Wave 5A — full write complete |
| INT-008 | Backend-for-Frontend Routing | integration | Draft | radii | @tech-lead-backend | `knowledge-base/patterns/integration/backend-for-frontend-routing.md` | T0, T1 | MS Cloud BFF | 2026-05-16 | 2 | Wave 5A — full write complete |
| INT-009 | Content-Based Router | integration | Draft | radii | @tech-lead-backend | `knowledge-base/patterns/integration/content-based-router.md` | T0, T1 | EIP §4 | 2026-05-16 | 2 | Wave 5A — full write complete |
| MOB-001 | Mobile Offline Queue | mobile | Draft | radii | @tech-lead-mobile | `knowledge-base/patterns/mobile/mobile-offline-queue.md` | T1, T2 | OWASP M2; PCI-DSS §3.5; Decree 13/2023 §9 | 2026-05-17 | 2 | Wave 5B — full write complete |
| MOB-002 | Mobile Secure Storage | mobile | Draft | radii | @tech-lead-mobile | `knowledge-base/patterns/mobile/mobile-secure-storage.md` | T0, T1 | OWASP M2; PCI-DSS §3.5; SBV Circ. 09 §III | 2026-05-17 | 2 | Wave 5B — full write complete |
| MOB-003 | Mobile Biometric Auth | mobile | Draft | radii | @tech-lead-mobile | `knowledge-base/patterns/mobile/mobile-biometric-auth.md` | T0, T1 | NIST SP 800-63B; PCI-DSS §8.4; SBV Circ. 09 §III.2 | 2026-05-17 | 2 | Wave 5B — full write complete |
| MOB-004 | Mobile Push Notification (Secure) | mobile | Draft | radii | @tech-lead-mobile | `knowledge-base/patterns/mobile/mobile-push-notification-secure.md` | T1, T2 | OWASP M7; PCI-DSS §6.4; Decree 13/2023 §17 | 2026-05-17 | 2 | Wave 5B — full write complete |
| MOB-005 | Mobile Deep Link Attestation | mobile | Draft | radii | @tech-lead-mobile | `knowledge-base/patterns/mobile/mobile-deep-link-attestation.md` | T0, T1 | OWASP M8; OWASP ASVS V6.3; SBV Circ. 09 §III | 2026-05-17 | 2 | Wave 5B — full write complete |
| MOB-006 | Mobile Force-Upgrade | mobile | Draft | radii | @tech-lead-mobile | `knowledge-base/patterns/mobile/mobile-force-upgrade.md` | T0, T1, T2 | OWASP M9; PCI-DSS §6.3.3; SBV Circ. 09 §II.3 | 2026-05-17 | 2 | Wave 5B — full write complete |
...
| PRIN-008 | Defense-in-Depth | principles | Draft | radii | @ciso-delegate | `knowledge-base/principles/defense-in-depth.md` | T0, T1, T2, T3 | NIST SP 800-53; PCI-DSS 4.0 multi-layer controls; SBV Circ. 09 §II (UNOFFICIAL) | 2026-05-09 | 1 | Stub — Wave 1 |
| PRIN-009 | Observability-First | principles | Draft | radii | @sre-lead | `knowledge-base/principles/observability-first.md` | T0, T1, T2, T3 | OpenTelemetry standards | 2026-05-09 | 1 | Stub — Wave 1 |
| PRIN-010 | Fail-Safe Defaults | principles | Draft | radii | @ciso-delegate | `knowledge-base/principles/fail-safe-defaults.md` | T0, T1, T2, T3 | NIST SP 800-160 | 2026-05-09 | 1 | Stub — Wave 1 |
| PRIN-011 | Least-Privilege | principles | Draft | radii | @ciso-delegate | `knowledge-base/principles/least-privilege.md` | T0, T1, T2, T3 | NIST SP 800-53 AC-6; PCI-DSS §7 | 2026-05-09 | 1 | Stub — Wave 1 |
| PRIN-012 | Async-by-default | principles | Draft | radii | @ea-board | `knowledge-base/principles/async-by-default.md` | T0, T1, T2 | — | 2026-05-09 | 1 | Stub — Wave 1 |
| PRIN-013 | Modular Monolith Preference | principles | Draft | radii | @ea-board | `knowledge-base/principles/modular-monolith-preference.md` | T1, T2, T3 | — | 2026-05-09 | 1 | Stub — Wave 1; counterbalance to PRIN-005 |
...
| RES-006 | Timeout Budget | resilience | Draft | radii | @sre-lead | `knowledge-base/patterns/resilience/timeout-budget.md` | T0, T1, T2 | Resilience4j TimeLimiter | 2026-05-09 | 1 | Stub — Wave 1 |
| RES-007 | Fallback Strategies | resilience | Draft | radii | @sre-lead | `knowledge-base/patterns/resilience/fallback-strategies.md` | T0, T1 | — | 2026-05-09 | 1 | Stub — Wave 1 |
| RES-008 | Throttling / Rate Limiting | resilience | Draft | radii | @sre-lead | `knowledge-base/patterns/resilience/throttling-rate-limiting.md` | T0, T1, T2 | MS Cloud Throttling | 2026-05-09 | 1 | Stub — Wave 1 |
| RES-009 | Load Shedding | resilience | Draft | radii | @sre-lead | `knowledge-base/patterns/resilience/load-shedding.md` | T0, T1 | — | 2026-05-09 | 1 | Stub — Wave 1 |
| RES-010 | Leader Election | resilience | Draft | radii | @sre-lead | `knowledge-base/patterns/resilience/leader-election.md` | T0, T1, T2 | MS Cloud Leader Election | 2026-05-09 | 1 | Stub — Wave 1 |
| RES-011 | Queue-Based Load Levelling | resilience | Draft | radii | @sre-lead | `knowledge-base/patterns/resilience/queue-based-load-levelling.md` | T0, T1, T2 | MS Cloud Queue-Based Load Leveling | 2026-05-09 | 1 | Stub — Wave 1 |
| RES-012 | Health Check Aggregation | resilience | Draft | radii | @sre-lead | `knowledge-base/patterns/resilience/health-check-aggregation.md` | T0, T1, T2, T3 | MS Cloud Health Endpoint Monitoring | 2026-05-09 | 1 | Stub — Wave 1 |
