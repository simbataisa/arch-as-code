...
| REF-005 | SWIFT MT/MX Wire Transfer | reference-architectures | Draft | radii | @payments-domain-owner | `knowledge-base/reference-architectures/swift-mt-mx-wire-transfer.md` | T0 | SWIFT CSP; ISO 20022 pacs | 2026-05-16 | 2 | Wave 5F — full write complete |
| REF-006 | Loan Origination | reference-architectures | Draft | radii | @lending-domain-owner | `knowledge-base/reference-architectures/loan-origination.md` | T1 | IFRS 9 | 2026-05-16 | 2 | Wave 5F — full write complete |
| REF-007 | Fraud Screening Platform | reference-architectures | Draft | radii | @risk-management-domain-owner | `knowledge-base/reference-architectures/fraud-screening-platform.md` | T0 | PSD2; FATF | 2026-05-16 | 2 | Wave 5F — full write complete |
| REF-008 | Regulatory Reporting | reference-architectures | Draft | radii | @head-of-compliance | `knowledge-base/reference-architectures/regulatory-reporting.md` | T1 | BCBS 239; SBV Reporting (UNOFFICIAL) | 2026-05-16 | 2 | Wave 5F — full write complete |
| REF-009 | Account Opening (Omnichannel) | reference-architectures | Draft | radii | @digital-channels-domain-owner | `knowledge-base/reference-architectures/account-opening-omnichannel.md` | T1 | FATF Rec. 10 | 2026-05-16 | 2 | Wave 5F — full write complete |
| REF-010 | Ledger Posting Engine | reference-architectures | Draft | radii | @core-banking-domain-owner | `knowledge-base/reference-architectures/ledger-posting-engine.md` | T0 | IFRS 9; BCBS 239 | 2026-05-16 | 2 | Wave 5F — full write complete |
| REF-011 | Open Banking (PSD2) | reference-architectures | Draft | radii | @digital-channels-domain-owner | `knowledge-base/reference-architectures/open-banking-psd2.md` | T1 | PSD2 RTS; FAPI 2.0 | 2026-05-16 | 2 | Wave 5F — full write complete |
| REF-012 | Dispute Management | reference-architectures | Draft | radii | @payments-domain-owner | `knowledge-base/reference-architectures/dispute-management.md` | T1 | Card-scheme rules | 2026-05-16 | 2 | Wave 5F — full write complete |
...
| SEC-006 | JWT Best Practices | security | Draft | radii | @ciso-delegate | `knowledge-base/patterns/security/jwt-best-practices.md` | T0, T1, T2 | RFC 8725 | 2026-05-16 | 1 | Wave 5E — gap-fill complete |
| SEC-007 | Secrets Rotation | security | Draft | radii | @ciso-delegate | `knowledge-base/patterns/security/secrets-rotation.md` | T0, T1, T2 | NIST SP 800-57; PCI-DSS §3.6 | 2026-05-16 | 1 | Wave 5E — gap-fill complete |
| SEC-008 | Data Masking | security | Draft | radii | @ciso-delegate | `knowledge-base/patterns/security/data-masking.md` | T0, T1, T2 | PCI-DSS §3.4; Decree 13/2023 (UNOFFICIAL) | 2026-05-16 | 1 | Wave 5E — gap-fill complete |
| SEC-009 | Fraud Signal Collection | security | Draft | radii | @risk-management-domain-owner | `knowledge-base/patterns/security/fraud-signal-collection.md` | T0, T1 | — | 2026-05-16 | 1 | Wave 5E — full write complete |
| SEC-010 | Attribute-Based Access Control | security | Draft | radii | @ciso-delegate | `knowledge-base/patterns/security/attribute-based-access-control.md` | T0, T1, T2 | NIST SP 800-162 | 2026-05-16 | 1 | Wave 5E — full write complete |
