...
| DATA-004 | Data Vault 2.0 | data | Draft | radii | @data-platform-domain-owner | `knowledge-base/patterns/data/data-vault-2.md` | T2, T3 | BCBS 239 §3 lineage | 2026-05-16 | 2 | Wave 5G — full write complete |
| DATA-005 | Slowly Changing Dimensions | data | Draft | radii | @data-platform-domain-owner | `knowledge-base/patterns/data/slowly-changing-dimensions.md` | T2, T3 | — | 2026-05-16 | 2 | Wave 5G — full write complete |
| DATA-006 | Lambda Architecture | data | Draft | radii | @data-platform-domain-owner | `knowledge-base/patterns/data/lambda-architecture.md` | T2, T3 | — | 2026-05-16 | 2 | Wave 5G — full write complete |
| DATA-007 | Kappa Architecture | data | Draft | radii | @data-platform-domain-owner | `knowledge-base/patterns/data/kappa-architecture.md` | T2, T3 | — | 2026-05-16 | 2 | Wave 5G — full write complete |
| DATA-008 | Change Data Capture (general) | data | Draft | radii | @tech-lead-backend | `knowledge-base/patterns/data/change-data-capture.md` | T0, T1 | BCBS 239 §3 | 2026-05-16 | 2 | Wave 5G — full write complete |
| DATA-009 | Data Lineage | data | Draft | radii | @data-platform-domain-owner | `knowledge-base/patterns/data/data-lineage.md` | T1, T2 | BCBS 239 §3 | 2026-05-16 | 2 | Wave 5G — full write complete |
| DATA-010 | Time-Series Modelling | data | Draft | radii | @data-platform-domain-owner | `knowledge-base/patterns/data/time-series-modelling.md` | T2, T3 | — | 2026-05-16 | 2 | Wave 5G — full write complete |
