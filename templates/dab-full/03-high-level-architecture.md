...
<!--
Drill down into one or more key services to show internal structure.
Components are logical groupings of functionality (not separately deployable by default).
Show dependencies, public interfaces, and key logic.

This example shows a typical service with API layer, business logic, and data access.
-->
...
graph TB
    ...
    Repository["Data Repository<br/>Pattern"]
    ...
    Repository -->|ORM| Domain

    style API fill:#4A90E2
    style Service fill:#50E3C2
    style Repository fill:#F5A623
    style Domain fill:#7ED321
    style Cache fill:#CCCCCC
    style Queue fill:#9013FE
```
...
|-----------|----------------|-------------|---------|
| [Component] | [What does it do?] | [Depends on...] | [Horizontal/Vertical] |
| [Component] | [What does it do?] | [Depends on...] | [Horizontal/Vertical] |
| [Component] | [What does it do?] | [Depends on...] | [Horizontal/Vertical] |

### Additional Service Components (if applicable)

For each major service, provide a similar component breakdown.
...
- [Infrastructure Design Document](07-infrastructure-design.md)
